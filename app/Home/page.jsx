...
const HomePage = () => {
    return (
        <div className="md:px-5 gap-20 lg:gap-5 lg:px-10 w-full h-full flex justify-center items-center flex-col px-20">
            ...
            <section className="flex-col gap-28 big:gap-40 w-full h-auto flex justify-center items-center">
                <div className="w-full relative flex items-center justify-between gap-10">
                    <h1 className="font-bold w-[50%] lg:text-[45px] sm:text-[45px] text-[4vw]">An <span className="relative">Easier <Image alt="underline" width={400} height={400} className="w-[45vw] sm:w-[230px] absolute -bottom-6 right-0 h-auto" src={'/Underline.png'} /></span> Way to be Sub and Find Sub</h1>
                    ...
                    <Image src={'/Curve2.png'} alt="curve2" className="w-[10vw] h-auto absolute left-[40%] top-[9vw]" width={400} height={400}/>
                </div>
                <div className="w-full flex h-auto justify-between items-center">
                    <Image className="w-[30%] h-auto" src={'/Home/h3.svg'} width={2000} height={2000} alt="h3" />
                    <Image className="w-[30%] h-auto" src={'/Home/h4.svg'} width={2000} height={2000} alt="h4" />
                    <Image className="w-[30%] h-auto" src={'/Home/h3.svg'} width={2000} height={2000} alt="h3" />
                </div>
            </section>
        </div>
